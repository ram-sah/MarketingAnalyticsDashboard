...
import { DashboardHeader, FunnelChart } from "@/components/dashboard";
  ...
  return (
    <div className="min-h-screen bg-dashboard-bg font-google text-dashboard-text">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-dashboard-text mb-2">Lead Generation Funnel</h1>
          <p className="text-gray-600">Track conversion rates through your sales funnel</p>
        </div>
